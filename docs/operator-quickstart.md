# Operator Quickstart — Manufacture of Batteries and Accumulators

Shortest path from clone to a verified local dry-run for **ISIC 2720** (`cloud-itonami-isic-2720`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2720.git
cd cloud-itonami-isic-2720
```
...
- Blueprint governor key: `cell-safety-governor`
- Likely source path: `cellworks.governor.cljc`
