...
`cloud-itonami-isic-2720` is an OSS open-business blueprint for lithium-ion
battery cell/pack manufacturing enablement, robotics-premised.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a robot action the governor refuses is never dispatched to hardware.
- the Cell-Safety Governor remains independent of the Cell Advisor.
